...
/**
 * Created by PercyChávez on 14, November, 2022.
...
fun SignUp() {
    Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
        Text(text = "Dont hace an account?", fontSize = 12.sp, color = Color(0xFFB5B5B5))
        Text(
            text = "Sign up.",
...
fun Body(modifier: Modifier, loginViewModel: LoginViewModel) {
    ...
    val isButtonEnable: Boolean by loginViewModel.isLoginEnable.observeAsState(initial = false)
...
fun SocialLogin() {
    Row(
        ...
        Image(
            painter = painterResource(id = R.drawable.ic_search_payment_method),
